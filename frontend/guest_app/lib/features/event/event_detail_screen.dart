...
class _EventDetailScreenState extends ConsumerState<EventDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (event == null) {
      ...
      return Scaffold(
        appBar:
            AppBar(title: const Text('Event'), backgroundColor: Colors.black),
        body: const Center(child: Text('Event not found or failed to load')),
      );
    }

    final rsvpStatus = event
        .myRsvpStatus; // Use event directly, it should be updated by controller state ideally
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(event.venueName ?? 'Unknown Location',
                      ...
                      children: [
                        ...
                        Expanded(
                          child: OutlinedButton(
                            ...
                            child: Text(rsvpStatus == 'interested'
                                ? 'Interested ✓'
                                : 'Interested'),
                          ),
                        ),
                  ...
                  if (event.friendsAttending.isEmpty)
                    const Text('No friends going yet. Be the first!',
                        ...
                        try {
                          ...
                          if (context.mounted) {
                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                content: Text('Could not join chat: $e')));
                          }
                        }
                      }
                    },
