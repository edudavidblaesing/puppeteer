...
final mapRepositoryProvider = Provider((ref) => MapRepository(ref.watch(apiServiceProvider)));

class MapRepository {
  final ApiService _api;
  MapRepository(this._api);

  Future<List<Event>> getEventsInArea({double? lat, double? lng, double? radius}) async {
