const { pool } = require('/usr/src/app/node_modules/@social-events/shared').db;
const eventService = require('/usr/src/app/node_modules/@social-events/shared').services.eventService;
