...
import { ArtistTable } from '@/components/features/tables/ArtistTable';
...
function ArtistsLayoutDetails({ children }: { children: React.ReactNode }) {
    ...
    const handleBulkDelete = async () => {
        if (!confirm(`Are you sure you want to delete ${selectedIds.size} artists?`)) return;
                ...
                <div className={clsx(
                    ...
                    <div className="p-4 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 space-y-4">
                        <div className="flex items-center justify-between gap-4">
                            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Artists</h1>
...
export default function ArtistsLayout({ children }: { children: React.ReactNode }) {
    return (
        <ArtistsProvider>
            <ArtistsLayoutContent>{children}</ArtistsLayoutContent>
        </ArtistsProvider>
    );
}
